	...
	#define V_COMMIT_HASH "80444c8"
#endif

#ifndef V_CURRENT_COMMIT_HASH
	#define V_CURRENT_COMMIT_HASH "80444c8"
#endif
...
VV_LOCAL_SYMBOL int compare_16947635374871024865_RepIndex_by_idx(RepIndex* a, RepIndex* b) {
...
int math__bits__trailing_zeros_16(u16 x) {
	...
	int _t2 = ((int)((*(byte*)/*ee elem_typ */array_get(_const_math__bits__de_bruijn32tab, ((u32)((x & -x))) * _const_math__bits__de_bruijn32 >> (27)))));
	return _t2;
}
...
int math__bits__trailing_zeros_32(u32 x) {
	...
	int _t2 = ((int)((*(byte*)/*ee elem_typ */array_get(_const_math__bits__de_bruijn32tab, ((x & -x)) * _const_math__bits__de_bruijn32 >> (27)))));
	return _t2;
}
...
int math__bits__trailing_zeros_64(u64 x) {
	...
	int _t2 = ((int)((*(byte*)/*ee elem_typ */array_get(_const_math__bits__de_bruijn64tab, ((x & -x)) * _const_math__bits__de_bruijn64 >> (58)))));
	return _t2;
}
...
VV_LOCAL_SYMBOL bool print_backtrace_skipping_top_frames_linux(int skipframes) {
	...
	#else
	{
		#if defined(__linux__) && !defined(_VFREESTANDING)
		{
			...
			for (int _t3 = 0; _t3 < sframes.len; ++_t3) {
				string sframe = ((string*)sframes.data)[_t3];
...
string string_replace_each(string s, Array_string vals) {
	...
	qsort(idxs.data, idxs.len, idxs.element_size, (int (*)(const void *, const void *))&compare_16947635374871024865_RepIndex_by_idx);
	byte* b = malloc_noscan(new_len + 1);
	int idx_pos = 0;
...
VV_LOCAL_SYMBOL void main__main(void) {
	println(_SLIT("welcome headshot"));
}
